...
public class DrinkMachine {
	...
	protected int input_money(int nextInt) {
		// 입금 start
	...
	protected int sell_drink(int sel, int money) {
		// 음료수 판매 start
		if (sel == 1) {
	...
	protected void return_money(int money) { // 거스름돈 반환 start
	...
	protected void menu_print() { // 메뉴 출력
